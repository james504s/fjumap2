        ...
        dashboardBody(
            ...
            tabItem(tabName="home",
                    fluidRow(
                      ...
                      h2("的師生及民眾擁有最佳的選擇。"),
                      br(),
                      img(src="eat2.png",height=300,width=300)
                    )),
